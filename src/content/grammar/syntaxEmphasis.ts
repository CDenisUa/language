  ...
  topics: [
    {
      ...
      examples: [
        ...
        { target: 'Here comes the train!', uk: 'Ось і потяг! (проста інверсія з іменником-підметом).' },
      ],
      exercises: [
        {
          id: 'inv-1',
    ...
    },
    {
      ...
      examples: [
        ...
        { target: "It wasn't until midnight that they arrived.", uk: 'Лише опівночі вони приїхали (it-cleft для наголосу на часі).' },
      ],
      exercises: [
        {
          id: 'cs-1',
    ...
    },
    {
      ...
      examples: [
        ...
        { target: 'This I cannot accept.', uk: 'Цього я не можу прийняти (об\'єкт this винесено на початок).' },
      ],
      exercises: [
        {
          id: 'fr-1',
    ...
    },
    {
      ...
      examples: [
        ...
        { target: 'Who broke the window?', uk: 'Хто розбив вікно? (питання до підмета, без do).' },
      ],
      exercises: [
        {
          id: 'qgs-1',
    ...
    },
    {
      ...
      examples: [
        ...
        { target: "Let's go for a walk, shall we?", uk: 'Ходімо прогуляємось, гаразд?' },
      ],
      exercises: [
        {
          id: 'qt-1',
